				...
				files: [
					{
						...
						description:
							"Used in Classic, Wedding, and Milestones Menu",
						file: "src/data/grand-menus/menus/basicsAppetizers.json",
						extension: "json",
						fields: menuFields,
					},
					{
						...
						file: "src/data/grand-menus/menus/basicsMains.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						...
						file: "src/data/grand-menus/menus/basicsMainsShared.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						...
						description:
							"Used in Classic, Wedding, and Milestones Menu",
						file: "src/data/grand-menus/menus/basicsSweets.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						...
						description:
							"Used in Classic, Wedding, and Milestones Menu",
						file: "src/data/grand-menus/menus/basicsDrinks.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						label: "Classic Menu",
						name: "classic menu",
						file: "src/data/grand-menus/menus/classicMenu.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						...
						name: "corporate menu",
						file: "src/data/grand-menus/menus/corporateMenu.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						...
						name: "milestone menu",
						file: "src/data/grand-menus/menus/milestoneMenu.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						label: "Wedding Menu",
						name: "wedding menu",
						file: "src/data/grand-menus/menus/weddingMenu.json",
						extension: "json",
						fields: [...menuFields],
					},
				],

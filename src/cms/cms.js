				...
				files: [
					{
						...
						file: "src/data/grand-menus/basicsAppetizers.json",
						extension: "json",
						fields: menuFields,
					},
					{
						...
						file: "src/data/grand-menus/basicsMains.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						...
						file: "src/data/grand-menus/basicsMainsShared.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						...
						description:
							"Used in Classic, Wedding, and Milestones Menu",
						file: "src/data/grand-menus/basicsSweets.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						...
						description:
							"Used in Classic, Wedding, and Milestones Menu",
						file: "src/data/grand-menus/basicsDrinks.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						label: "Classic Menu",
						name: "classic menu",
						file: "src/data/grand-menus/classicMenu.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						...
						name: "corporate menu",
						file: "src/data/grand-menus/corporateMenu.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						...
						name: "milestone menu",
						file: "src/data/grand-menus/milestoneMenu.json",
						extension: "json",
						fields: [...menuFields],
					},
					{
						label: "Wedding Menu",
						name: "wedding menu",
						file: "src/data/grand-menus/weddingMenu.json",
						extension: "json",
						fields: [...menuFields],
					},
				],

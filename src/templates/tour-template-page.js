    ...
    <Layout status={status}>
      ...
      <div className="page-image-full page-image-full--clean">
        <Video
          source={[
            {
              src: `/video/rooms/${pageName}.compressed.mp4`,
              type: 'video/mp4'
            },
            {
              src: `/video/rooms/${pageName}.compressed.ogv`,
              type: 'video/ogv'
            },
            {
              src: `/video/rooms/${pageName}.compressed.webm`,
              type: 'video/webm'
            }
          ]}
      ...
      />
      <PageSection subHead={frontmatter.upgrades.description}>

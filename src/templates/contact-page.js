  ...
  return (
    <Layout status={status}>
      ...
      <PageSection wrapperClassName="xs-py5 contact--item contact--item--left">
        <p className="xs-col-12 md-col-10 md-offset-1 xs-text-3 xs-mt5 xs-text-center">
          <a href={`tel:${siteDetails.phone}`}>
            {util.formatPhoneNumber(siteDetails.phone)}
          </a>
        </p>
        <h1 className="h1 display">Call</h1>
      </PageSection>
      <PageSection wrapperClassName="xs-py5 contact--item contact--item--right">
        <p className="xs-col-12 md-col-10 md-offset-1 xs-text-3 xs-mt5 xs-text-center">
          <a href={`mailto:${siteDetails.email}?subject=Saying Hello`}>
            {siteDetails.email}
          </a>
        </p>
        <h1 className="h1 display">Email</h1>
      </PageSection>
      <PageSection wrapperClassName="xs-py5 contact--item contact--item--left">
        <p className="xs-col-12 md-col-10 md-offset-1 xs-text-3 xs-mt5 xs-text-center">
          <Link to="/inquire">{"Submit Inquiry"}</Link>
        </p>
        <h1 className="h1 display">Inquire</h1>
      </PageSection>
      <PageSection wrapperClassName="xs-py5 xs-col-12 md-col-8 md-offset-2">
        {socialNav.map((item, i) => (
          <div key={i} className="contact--item col xs-col-12 md-col-6 xs-my6">
            <p className="xs-text-3 xs-text-center">

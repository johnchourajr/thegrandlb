...
const headline = {
  ...
  min: {
    ...
    2: ms(1.3, MIN_RATIO, 5),
    3: ms(1.2, MIN_RATIO, 4),
    4: ms(1.2, MIN_RATIO, 3),
    5: ms(1.1, MIN_RATIO, 2),
    6: ms(1.1, MIN_RATIO, 1),
  },
};
...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      "string-large": clampBuilder(375, 1024, 0.7, 0.85),
      "string-default": clampBuilder(375, 1024, 0.65, 0.75),
      "string-small": clampBuilder(375, 1024, 0.6, 0.65),
      "string-extra-small": clampBuilder(375, 1024, 0.6, 0.625),
      "paragraph-large": clampBuilder(375, 1024, 0.85, 1.125),
      "paragraph-default": clampBuilder(375, 1024, 0.75, 1),
      "paragraph-small": clampBuilder(375, 1024, 0.7, 0.875),

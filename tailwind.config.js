...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      "string-large": clampBuilder(375, 1024, 0.75, 1),
      "string-default": clampBuilder(375, 1024, 0.6875, 0.8125),
      "string-small": clampBuilder(375, 1024, 0.625, 0.6875),
      "string-extra-small": clampBuilder(375, 1024, 0.6, 0.625),
      "paragraph-large": clampBuilder(375, 1024, 1.125, 1.25),
      "paragraph-default": clampBuilder(375, 1024, 0.875, 1),
      "paragraph-small": clampBuilder(375, 1024, 0.8125, 0.875),

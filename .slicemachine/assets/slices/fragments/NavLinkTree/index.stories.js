import MyComponent from '../../../../../slices/fragments/NavLinkTree';

export default {
  title: 'slices/fragments/NavLinkTree'
}


export const _Default = () => <MyComponent slice={{"variation":"default","version":"sktwi1xtmkfgx8626","items":[{}],"primary":{"link_title":"diagram","link_source":{"link_type":"Web","url":"https://slicemachine.dev"},"display":true},"id":"_Default","slice_type":"nav_link_tree"}} />
_Default.storyName = ''
